...
INSERT INTO tg.GeoOkres VALUES(1, 1, 'Czwartorzęd');
...
INSERT INTO tg.GeoEpoka VALUES(8, 4, 'Późna Kreda');
INSERT INTO tg.GeoEpoka VALUES(9, 4, 'Wczesna Kreda');
INSERT INTO tg.GeoEpoka VALUES(10, 5, 'Jura Późna');
INSERT INTO tg.GeoEpoka VALUES(11, 5, 'Jura Środkowa');
INSERT INTO tg.GeoEpoka VALUES(12, 5, 'Jura Wczesna');
INSERT INTO tg.GeoEpoka VALUES(13, 6, 'Późny Trias');
INSERT INTO tg.GeoEpoka VALUES(14, 6, 'Środkowy Trias');
...
INSERT INTO tg.GeoEpoka VALUES(21, 9, 'Późny Dewon');
INSERT INTO tg.GeoEpoka VALUES(22, 9, 'Środkowy Dewon');
...
INSERT INTO tg.GeoEpoka VALUES(28, 11, 'Ordowik Późny');
INSERT INTO tg.GeoEpoka VALUES(29, 11, 'Ordowik Środkowy');
...
INSERT INTO tg.GeoEpoka VALUES(33, 12, 'Oddział 2');
...
INSERT INTO tg.GeoPietro VALUES(4, 2, 'Późny');
...
INSERT INTO tg.GeoPietro VALUES(14, 4, 'Burdygał');
...
INSERT INTO tg.GeoPietro VALUES(35, 9, 'Walanżyn');
...
INSERT INTO tg.GeoPietro VALUES(64, 19, 'Gżel');
...
INSERT INTO tg.GeoPietro VALUES(73, 22, 'Żyewt');
...
INSERT INTO tg.GeoPietro VALUES(93, 31, 'Piętro 10');
INSERT INTO tg.GeoPietro VALUES(94, 31, 'Dziangszan');
INSERT INTO tg.GeoPietro VALUES(95, 31, 'Paib');
INSERT INTO tg.GeoPietro VALUES(96, 32, 'Gużang');
INSERT INTO tg.GeoPietro VALUES(97, 32, 'Drum');
INSERT INTO tg.GeoPietro VALUES(98, 32, 'Wuliuan');
INSERT INTO tg.GeoPietro VALUES(99, 33, 'Piętro 4');
INSERT INTO tg.GeoPietro VALUES(100, 33, 'Piętro 3');
INSERT INTO tg.GeoPietro VALUES(101, 34, 'Piętro 2');
INSERT INTO tg.GeoPietro VALUES(102, 34, 'Fortun');

SELECT * FROM tg.GeoPietro;

--Stowrzenie tabeli zdenormalizowanej

CREATE TABLE tg.GeoTabela AS (SELECT * FROM tg.GeoPietro NATURAL JOIN tg.GeoEpoka NATURAL
JOIN tg.GeoOkres NATURAL JOIN tg.GeoEra NATURAL JOIN tg.GeoEon );

ALTER TABLE tg.GeoTabela ADD PRIMARY KEY (id_pietro);

SELECT * FROM tg.GeoTabela;

--Stworzenie tabeli dzieciec i milon
...
(mod(tg.Milion.liczba,102)=(tg.GeoTabela.id_pietro));

--Zapytanie 2

SELECT COUNT(*) FROM tg.Milion INNER JOIN tg.GeoPietro ON
(mod(tg.Milion.liczba,102)=tg.GeoPietro.id_pietro) NATURAL JOIN tg.GeoEpoka NATURAL JOIN
tg.GeoOkres NATURAL JOIN tg.GeoEra NATURAL JOIN tg.GeoEon;


--Zapytanie 3

SELECT COUNT(*) FROM tg.Milion WHERE mod(tg.Milion.liczba,102)=
(SELECT id_pietro FROM tg.GeoTabela WHERE mod(tg.Milion.liczba,102)=(id_pietro));

--Zapytanie 4

SELECT COUNT(*) FROM tg.Milion WHERE mod(tg.Milion.liczba,102) IN
(SELECT tg.GeoPietro.id_pietro FROM tg.GeoPietro NATURAL JOIN tg.GeoEpoka NATURAL JOIN
tg.GeoOkres NATURAL JOIN tg.GeoEra NATURAL JOIN tg.GeoEon);
